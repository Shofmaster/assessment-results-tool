...
import {
  AUDIT_AGENTS as _AUDIT_AGENTS,
  PAPERWORK_REVIEW_AGENT_IDS as _PAPERWORK_REVIEW_AGENT_IDS,
  DCT_TRACEABILITY_AGENT_IDS as _DCT_TRACEABILITY_AGENT_IDS,
  DEFAULT_PUBLIC_USE_CONFIG as _DEFAULT_PUBLIC_USE_CONFIG,
  PUBLIC_USE_ENTITY_TYPE_LABELS as _PUBLIC_USE_ENTITY_TYPE_LABELS,
  PUBLIC_USE_AUDIT_FOCUS_LABELS as _PUBLIC_USE_AUDIT_FOCUS_LABELS,
  type ISBAOStage as _ISBAOStage,
} from '../data/auditAgentDefinitions';

// Re-export data-layer constants so existing import sites don't need to change.
export { _AUDIT_AGENTS as AUDIT_AGENTS };
export { _PAPERWORK_REVIEW_AGENT_IDS as PAPERWORK_REVIEW_AGENT_IDS };
export { _DCT_TRACEABILITY_AGENT_IDS as DCT_TRACEABILITY_AGENT_IDS };
export { _DEFAULT_PUBLIC_USE_CONFIG as DEFAULT_PUBLIC_USE_CONFIG };
export { _PUBLIC_USE_ENTITY_TYPE_LABELS as PUBLIC_USE_ENTITY_TYPE_LABELS };
export { _PUBLIC_USE_AUDIT_FOCUS_LABELS as PUBLIC_USE_AUDIT_FOCUS_LABELS };
export type { _ISBAOStage as ISBAOStage };

// Local aliases so the rest of this file can use the un-prefixed names.
const AUDIT_AGENTS = _AUDIT_AGENTS;
const DEFAULT_PUBLIC_USE_CONFIG = _DEFAULT_PUBLIC_USE_CONFIG;
const PUBLIC_USE_ENTITY_TYPE_LABELS = _PUBLIC_USE_ENTITY_TYPE_LABELS;
const PUBLIC_USE_AUDIT_FOCUS_LABELS = _PUBLIC_USE_AUDIT_FOCUS_LABELS;
...
import { getPaperworkReviewSystemPrompt } from './auditAgentPaperworkPrompts';
export { getPaperworkReviewSystemPrompt };
...
// ISBAOStage is defined in auditAgentDefinitions and re-exported above; alias for internal use.
type ISBAOStage = _ISBAOStage;
