...
export const FEATURE_KEYS = {
  ...
  /**
   * Optional Voyage rerank on the Ask hot path (default off — hybrid fusion is
   * usually enough; enable when latency budget allows higher precision).
   */
  ASK_RERANK: 'ask-rerank',
...
export const FEATURE_LABELS: Record<FeatureKey, string> = {
  ...
  'ask-rerank': 'Ask an Expert Rerank',
