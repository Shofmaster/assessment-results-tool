...
function ChatThread({
  ...
  return (
    <div className="mt-3 max-h-[min(45vh,640px)] overflow-y-auto overflow-x-hidden rounded-xl border border-white/10 bg-navy-900/45 p-4 pr-3 [scrollbar-gutter:stable]">
...
export default function SplashPage() {
  ...
  return (
    <div className="box-border flex w-full min-h-full flex-col px-3 py-4 sm:px-4 sm:py-6 md:px-8 md:py-8 lg:px-12 xl:px-16">
      <div className="mx-auto my-auto w-full min-w-0 max-w-4xl lg:max-w-5xl xl:max-w-6xl">
