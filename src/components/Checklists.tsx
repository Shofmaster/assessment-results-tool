...
import {
  ...
  type DueFilter,
  type ExecutionSort,
  getChecklistItemDisplayDue,
  dueBadgeClass,
  computeComplianceScore,
  itemMatchesDueFilter,
  sortExecutionItems,
  wouldCloseCycleBeLate,
  downloadChecklistOccurrencesCsv,
  getStatusLabel,
} from "./checklists/checklistsUtils";

/** Stable empty fallbacks — `|| []` in render creates a new array every time and
 *  retriggers effects that sync drafts from query results (infinite re-render / #301). */
